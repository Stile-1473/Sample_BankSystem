...
// Creator: ghost1473
 if (!empty($error)): ?>
      ...
      <?php endif; ?>
      <h2 style="margin:0 0 .75rem 0;"><i class="ri-question-line"></i> Forgot Password</h2>
      <form method="POST" action="index.php?url=auth/handleForgotPassword">
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="phone" placeholder="Your phone number" required class="form-control">
        </div>
        <button type="submit" class="btn btn-primary w-100"><i class="ri-mail-send-line"></i> Verify</button>
      </form>
    </div>
