...
<body>
  <div class="dashboard-layout">
    <aside class="sidebar">
      <div class="brand"><i class="ri-bank-line"></i> Goft Admin</div>
      <nav>
        ...
        <a href="index.php?url=account/all"><i class="ri-briefcase-3-line"></i> View All Accounts</a>
        <a href="index.php?url=transaction/all"><i class="ri-swap-box-line"></i> Transactions</a>
        <a href="index.php?url=auditlog/index"><i class="ri-file-list-3-line"></i> Audit Logs</a>
      ...
      <div class="dashboard-content">
        ...
        <div class="card" style="margin-top:1rem;">
          ...
          <div style="display:flex; gap:.6rem; flex-wrap:wrap;">
            ...
            <a class="btn btn-primary" href="index.php?url=transaction/all"><i class="ri-arrow-left-right-line"></i> View Transactions</a>
            <a class="btn btn-primary" href="index.php?url=auditlog/index"><i class="ri-clipboard-line"></i> Audit Logs</a>
          </div>
        </div>
      </div>
    </main>
